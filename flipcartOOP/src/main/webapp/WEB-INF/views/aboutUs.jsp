				...
				<div class="content">
					...
					<div class="entry">
						...
						<div class="text">
							...
							<ul>
								<li><span>1.</span>Phasellus vitae enim non quam adipiscing
									suscipit nec quis mauris.</li>
								<li><span>2.</span>Vivamus feugiat erat vel pellentesque
									luctus.</li>
								<li><span>3.</span>Nullam ac urna facilisis, fringilla arcu
									in, sodales velit.</li>
								<li><span>4.</span>Nam tempus nisi ornare urna mollis
									cursus.</li>
							</ul>
						</div>
						...
						<div class="text">
							<p>
								...
								rerum facilis est et expedita distinctio. <a href="">Nam
									libero tempore, cum soluta nobis est eligendi optio cumque
									nihil impedit quo minus id quod maxime placeat facere possimus,
									omnis voluptas assumenda est, omnis dolor repellendus. </a>Temporibus

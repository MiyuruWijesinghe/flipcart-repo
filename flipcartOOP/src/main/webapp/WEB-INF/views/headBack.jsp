...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="<%=request.getContextPath()%>/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
  ...
  <!-- Select2 -->
  <link rel="stylesheet" href="<%=request.getContextPath()%>/bower_components/select2/dist/css/select2.min.css">	
</head>

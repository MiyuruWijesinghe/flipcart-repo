...
<div class="content-wrapper">
		...
		<section class="content-header">
			<h1>
				Sellers List <small>Preview</small>
			</h1>
			<ol class="breadcrumb">
				...
				<div class="col-xs-12">
					<div class="box">
						<div class="box-header">
							<h3 class="box-title">
								Sellers<span><a href="<%=request.getContextPath()%>/seller-add-page"> + Add New Seller</a></span>
							</h3>
						</div>
						<!-- /.box-header -->
						<div class="box-body">
							<table id="example2" class="table table-bordered table-hover">
								...
								<%
									SellerService sellerService = new SellerServiceImpl();
										ArrayList<Seller> arrayList = sellerService.getSellers();
